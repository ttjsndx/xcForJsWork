...
function showInfo(info){
	...
	var height = 150;
	if(infoLength > 10){
		height = Math.ceil(Math.sqrt(infoLength/3))*150 ;
	}
	var width = height*3;
	...
	myDiv.innerHTML = "<div class='alertDiv' style='width:" + width 
								+ "px;height:" + height
								+ "px;top:" + top
								+ "px;left:" + left
								+ "px;'  id='messageWindowId'>" 
						+ "<div class='alertDivTop'> "
							+ info 
						+ "</div>"
						+ "<div class='alertDivFloor'> "
							+ "<input type='button' onclick='' value='关闭'>"
						+ "</div>" 
					+ "</div>";
